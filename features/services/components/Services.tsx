...
import { AnimatedButton, AnimatedDescription, AnimatedImageContainer, AnimatedTitle } from "@/features/animations/components/animated-component";
            ...
            <div className="flex lg:w-[92%] w-[90%] sm:gap-10 gap-4 flex-col">
                ...
                <div className="w-full flex sm:flex-row flex-col sm:gap-10 gap-4">
                    ...
                    <div className="sm:w-6/12 flex flex-col  sm:gap-14 gap-6">
                        <AnimatedDescription className="text-[#212121] sm:text-lg text-base sm:tracking-wide tracking-normal text-justify leading-7 pt-4">
                            ...
                            <AnimatedTitle>
                                {servicesData.map((data, index) => (
                                    <div key={data.title}>
                                        ...
                                        >
                                            <div
                                                className="relative flex w-full justify-between items-center cursor-pointer sm:h-20 h-14"
                                                onClick={() => handleServiceClick(index)}
                                            >
                                                <div className="sm:text-4xl text-xl font-medium">
                                                    {data.title}
                                                </div>
                                                ...
                                                {/* TODO: Customize and add this later */}
